...
def forward(q, k, v, causal=False, query_tile=32, key_tile=64):
    if not q.is_cuda:
    ...
    _forward[(triton.cdiv(nq, query_tile), batch)](q, k, v, o, l, nq, nk, d, query_tile, key_tile, causal, num_warps=4)
    return o, l


def backward(q, k, v, o, do, l, causal, tile=32):
    ...
    _backward_kv[(triton.cdiv(nk, tile), batch)](q, k, v, do, l, delta, dk, dv, nq, nk, d, tile, tile, causal, num_warps=4)
    _backward_q[(triton.cdiv(nq, tile), batch)](q, k, v, do, l, delta, dq, nq, nk, d, tile, 64, causal, num_warps=4)
    return dq, dk, dv
