...
def make_plan(name, gpus):
    ...
    if name == "tuned-validation":
        return [{"name": "tuned-validation", "kind": "validate_optimized", "tuned": True, "timeout": 300}]
    if name == "leaderboard-tuned":
        return [{"name": "leaderboard-tuned-8b-32768", "kind": "leaderboard", "seq": 32768,
                 "warmup": 2, "steps": 5, "chunk": 512, "tuned": True, "timeout": 590}]
